...
export default function Image_() {
  ...
  const content = [
    ...
    <p>
      This second piece in the series came from a happy accident. When sourcing
      hard drive platters, I received a lot of platters that had been punctured
      in order to destroy any residual data on them. This extra step is
      sometimes taken for recycled hard drives that may have contained sensitive
      information. The resulting objects are more sculpturally dynamic,
      producing warped reflections and revealing the presence of physical
      violence in their history. In this piece I also experimented with using
      gold-coated platters for color variation, and broken shards of platters as
      both texture and symbolism.
    </p>,
    <Image
