    ...
    () =>
      ...
      Children.map(pictures, (_picture, i) => {
        ...
        return cloneElement(picture, {
          className: `object-contain min-w-full sm:h-full sm:py-4 max-sm:max-h-full max-sm:px-4 snap-center ${
            i === 0 && showScroll
  ...
  return (
    <>
      <section
        ...
        id="pictures"
        className="relative min-h-60dvh w-full max-h-full sm:overflow-y-auto sm:overflow-x-hidden sm:no-scrollbar sm:h-full max-sm:overflow-x-auto max-sm:overflow-y-hidden max-sm:flex snap-both snap-mandatory"
      >
        {content}
      </section>
    </>
