...
export default function TimeSpace() {
  const content = [
    ...
    <p>
      Time-Space is a video series of temporally perpendicularized videos. This
      project was inspired by my theory of art and spirituality and is meant to
      illustrate the underlying metaphysics to my theory.
      <br />
      ---
      <br />
    ...
    />,
    <p>
      Temporal perpendicularization is the re-encoding of a video file to pivot
      the time dimension 90°.
    </p>,
    <Image
    ...
    <p>
      ...
      ---
      <br />
      When watching the video, you are seeing a specific spatial slice at every
      moment in time. As the video progresses, you are watching that slice slide
      across the width of the original video.
    </p>,
    <Image
    ...
    <p>
      ...
      re-encoding of the information of our reality that perpendicularizes time.
      Places would become moments and moments would become spaces. I have had
      spiritual experiences, and I have witnessed great art, and I suspect I am
      witnessing the same thing in both. Perhaps the magical moments we
      encounter are re-encoded masterpieces. Perhaps our masterpieces are
      revelations for some re-encoded xenosapien. Perhaps we can imagine it and
      make it true.
    </p>,
    <video
      src="/computational/time-space/globe-light-glass.mp4"
    ...
    <p>
      This video was created from a shot of the orange line passing by my house.
      The consistent linear motion of the two trains translates into static
      horizontal sections of the transformed video. The waviness comes from the
      handheld nature of the original video.
      <br />
      ---
      <br />
      Video available{" "}
    ...
    <p>
      ...
      of the video is due to a change in camera angle, where I zoomed in on the
      boiling bubbles in the later part of the original video.
      <br />
      ---
      <br />
      Video available{" "}
    ...
    <p>
      ...
      defracted lights in wave-like patterns floating throughout the frame. This
      piece in particular inspired another possible connection to physics
      ...
      transforms into wavy patterns that remind me of wave-function simulations.
      Could the application of relativity to a true point particle result in the
      temporal and spatial dimensions overlapping and their distinction becoming
      blurred, thus creating an environment ripe for non-causality? Without a
      doubt this is not the case; I am not a physicist by any stretch of the
      imagination. But it's fun to think about.
      <br />
      ---
      <br />
    ...
    <p>
      ...
      first encounters Lloyd the bartender. This was the first video that I made
      that featured a human being and it is a dramatic and creepy effect.
      <br />
      ---
      <br />
    ...
    <p>
      The source for this is an Apple TV screensaver of jellyfish. This one was
      interesting because of how immediately recognizable the result is. So much
      of the sense of the original video is present in this one, more than any
      other piece in the series.
      <br />
      ---
      <br />
    ...
    <p>
      ...
      camera angle cuts, lots of movement and color, and captions running across
      the bottom, all of which create substantially interesting results when
      temporally perpendicularized.
      <br />
      ---
      <br />
    ...
    <p>
      ...
      Due to the resolution and framerate of the original video, the Time-Space
      version ends up with a resolution of 360 x 800 and is 64 seconds long. All
      previous pieces have been created such that the width and number of frames
      would be identical, resulting in identical resolutions between the
      original and transformed videos, so this is a great example to illuminate
      that aspect of the transformation.
      <br />
      ---
      <br />
      Video available{" "}
