...
export default function Nav() {
  ...
  return (
    <nav
      className={`z-10 flex flex-col gap-4 items-end rounded-tl-lg bg-fg text-bg fixed bottom-0 right-0 overflow-hidden p-4 w-min *:no-underline hover:*:underline ${
        open[0]
